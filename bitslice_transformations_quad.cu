...
void from_bitslice_quad(const uint32_t *const __restrict__ input, uint32_t *const __restrict__ output)
{
	...
	output[0] = __byte_perm(output[0], SHFL((int)output[0], (threadIdx.x + 1) & 3, 4), 0x7610);
	output[2] = __byte_perm(output[2], SHFL((int)output[2], (threadIdx.x + 1) & 3, 4), 0x7610);
	output[4] = __byte_perm(output[4], SHFL((int)output[4], (threadIdx.x + 1) & 3, 4), 0x7632);
	output[6] = __byte_perm(output[6], SHFL((int)output[6], (threadIdx.x + 1) & 3, 4), 0x7632);
	output[8] = __byte_perm(output[8], SHFL((int)output[8], (threadIdx.x + 1) & 3, 4), 0x7610);
	output[10] = __byte_perm(output[10], SHFL((int)output[10], (threadIdx.x + 1) & 3, 4), 0x7610);
	output[12] = __byte_perm(output[12], SHFL((int)output[12], (threadIdx.x + 1) & 3, 4), 0x7632);
	output[14] = __byte_perm(output[14], SHFL((int)output[14], (threadIdx.x + 1) & 3, 4), 0x7632);

	output[0 + 1] = SHFL((int)output[0], (threadIdx.x + 2) & 3, 4);
	output[2 + 1] = SHFL((int)output[2], (threadIdx.x + 2) & 3, 4);
	output[4 + 1] = SHFL((int)output[4], (threadIdx.x + 2) & 3, 4);
	output[6 + 1] = SHFL((int)output[6], (threadIdx.x + 2) & 3, 4);
	output[8 + 1] = SHFL((int)output[8], (threadIdx.x + 2) & 3, 4);
	output[10 + 1] = SHFL((int)output[10], (threadIdx.x + 2) & 3, 4);
	output[12 + 1] = SHFL((int)output[12], (threadIdx.x + 2) & 3, 4);
	output[14 + 1] = SHFL((int)output[14], (threadIdx.x + 2) & 3, 4);
...
void from_bitslice_quad_final(const uint32_t *const __restrict__ input, uint32_t *const __restrict__ output)
{
	...
	output[6] = __byte_perm(output[6], SHFL((int)output[6], (threadIdx.x + 1) & 3, 4), 0x7632);
	output[7] = SHFL((int)output[6], (threadIdx.x + 2) & 3, 4);
